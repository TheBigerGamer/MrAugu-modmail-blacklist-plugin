...
module.exports = class {
  ...
  async run (message) {
   ...
   response.replace('{{user}}', message.author.username).replace('{{reason}}', userData.reason).replace('{{moderator}}', userData.moderator).replace('{{prefix}}',this.client.config.prefix)
